/* ============================================================
   ...
   ★ カスタマイズはこの CONFIG を書き換えるだけでOK！ ★
   （HTML/CSSは基本さわらなくてもテキストが差し替わります）
============================================================= */
...
const CONFIG = {
  ...
  avatarEmoji: "🎤", // アバターに表示する絵文字。好きな絵文字に変えてOK

  // プロフィール（label: value の組み合わせを自由に増減できます）
  profile: [
